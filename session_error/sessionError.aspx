<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sessionError.aspx.cs" Inherits="session_error_sessionError" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title runat="server" id="pageTitle">Error Page</title>
    ...
    <div class="container" id="QuoViewDetailsBuglary" runat="server">
       ...
       <div class="form-group row h-auto" runat="server">
           ...
           <div class="col-sm-2 align-content-end" id ="two">
                ...
                <asp:Button id="bt_ok" runat="server" Text="Done" class="btn btn-info" ClientIDMode="Static"/>
           </div>
        </div>
