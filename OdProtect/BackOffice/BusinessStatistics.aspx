<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Odb.master" AutoEventWireup="true" CodeFile="BusinessStatistics.aspx.cs" Inherits="OdProtect_BackOffice_BusinessStatistics_" Culture = "en-GB"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            ...
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Progress View Statistics</label>
            </div>

            <div class="row col-sm-3">
                <asp:LinkButton ID="lnk_moreInfo" runat="server" PostBackUrl="~/OdProtect/BackOffice/BusinessStatistics_Info.aspx">[ Click here for more information ]</asp:LinkButton>
                </div>
        </div>
        <div class="form-group row" runat="server">
