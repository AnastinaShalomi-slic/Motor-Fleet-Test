<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminView.aspx.cs" Inherits="AdminPanel_AdminView" Culture="en-GB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Fire Progress View Panel</label>
        </div>
        <div class="form-group row" runat="server">
        ...
        <div class="form-group row" runat="server">
            ...
            <%-- <div class="col-sm-2 mr-0 testClass" runat="server">
              ...
              <asp:TextBox ID="txtNicNo" runat="server" CssClass="form-control text-center testClass text-uppercase"  ClientIDMode="Static" placeholder="NIC"></asp:TextBox>  
              </div>--%>
            ...
            <div class="col-sm-1 mr-0 testClass" runat="server">
                ...
                <%--  <asp:Button ID="btexcel" runat="server"
                                 Text="Download"  Width="75px" ClientIDMode="Static" 
                                  CssClass="btn_clz" OnClick="btexcel_Click" OnClientClick="AlertDownload()"  />--%>
            </div>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="Grid_Details" Visible="true" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="8"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Count" DataField="dh_count" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass" />
                                    ...
                                    <asp:BoundField HeaderText="Total Premium" DataField="total" DataFormatString="{0:n2}" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass" />
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridViewTotalCount" Visible="true" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="8"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="No" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_index" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    ...
                                    <asp:BoundField HeaderText="Overall Total" DataField="dh_count" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass" />
                                    <asp:BoundField HeaderText="Overall Premium" DataField="total" DataFormatString="{0:n2}" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass" />
