<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewProposal.aspx.cs" Inherits="Bank_Fire_ViewProposal" Culture = "en-GB"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        $(function () {
            $("[id$=txt_req_id]").autocomplete({
                ...
                source: function (request, response) {
                    ...
                    $.ajax({
                        url: '<%=ResolveUrl("~/Bank_Fire/ViewProposal.aspx/GET_POL_NO") %>',
    ...
    <asp:HiddenField ID="brCode" runat="server" />
     ...
     <div class="" id="viewPropId" runat="server">
       <%-- <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Get Fire Policy Schedule</label>
        </div>--%>
       <div class="form-group row" runat="server">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddl_status" runat="server" class="custom-select testClass text-center"
                               ...
                               <asp:ListItem Text="Completed" Value="N"></asp:ListItem>
         ...
         <div class="form-group row" runat="server">
           ...
           <asp:CompareValidator ID="comp_val" ValidationGroup = "VG0001" ForeColor = "Red" runat="server" 
             ...
             <div class="col-sm-2 mr-0 testClass" runat="server">
              ...
              <div class="col-sm-3 mr-0 testClass" runat="server"></div>
             </div>
         <hr class="bg-info"/>
 ...
 <div class="form-group row" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="Grid_Details" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="8"
                              ...
                              <asp:TemplateField HeaderText="S.No" HeaderStyle-CssClass="text-dark testClassHeader" ItemStyle-CssClass="text-black-100 testClass">
                               ...
                               <ItemTemplate>
                                  <asp:Label ID="lblRefNo" runat="server" Text='<%# Bind("DH_REFNO") %>'></asp:Label>
                               </ItemTemplate>     
                               <ItemStyle />              
                               </asp:TemplateField> 
                                ...
                                <asp:BoundField HeaderText="DebitNo"  DataField="DEBIT_NO"  ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />                               
                                <asp:BoundField HeaderText="Loan Number"  DataField="LOAN_NUMBER" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>   
                                <asp:BoundField HeaderText="Name of Insured"  DataField="DH_NAME" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>    
                                <asp:BoundField HeaderText="From Date"  DataField="fromDate" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>
                                <asp:BoundField HeaderText="To Date"  DataField="toDate" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>                                
                                ...
                                <asp:BoundField HeaderText="Phone Number"  DataField="DH_PHONE" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>
                                ...
                                <asp:BoundField HeaderText="Status"  DataField="DH_FINAL_FLAG" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>  
                               ...
                               <ItemTemplate>
                                   ...
                                   <asp:ImageButton ID="imgbtn_select" runat="server"  CommandArgument = '<%#Eval("DH_REFNO")+";"+ Eval("SC_POLICY_NO")+";"+ Eval("DH_VALU_TOTAL")+";"+ Eval("DH_FINAL_FLAG")%>'  CausesValidation= "false" 
                               ...
                               <ItemTemplate>
                                   ...
                                   <asp:ImageButton ID="imgbtn_select2" runat="server"  CommandArgument = '<%#Eval("DH_REFNO")+";"+ Eval("SC_POLICY_NO")+";"+ Eval("DH_VALU_TOTAL")%>'  CausesValidation= "false" 
                                   CommandName="cmd"  ImageUrl="~/Images/icons8-edit-64.png" OnClick="SelectRecord_Click2" CssClass="img-fluid img_sizeIcon"/>
                               ...
                               <asp:TemplateField HeaderText="Policy No" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" >
                               <ItemTemplate>
                                  <asp:Label ID="lblPolNo" runat="server" Text='<%# Bind("SC_POLICY_NO") %>'></asp:Label>
                               </ItemTemplate>     
                               <ItemStyle />              
                               </asp:TemplateField> 

                              <asp:TemplateField HeaderText="Sum Val" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" >
                               <ItemTemplate>
                                  <asp:Label ID="lblSumInsu" runat="server" Text='<%# Bind("DH_VALU_TOTAL") %>'></asp:Label>
                               </ItemTemplate>     
                               <ItemStyle />              
                               </asp:TemplateField> 
           ...
           <%--  add officer details--%>
            ...
            <div class="main" id="details_officer" runat="server" visible="false">
            <div class="officer"><p><strong>Sales Officer Details</strong></p><br />
    ...
    <LayoutTemplate>
        ...
        <div class="underWrite"><p><strong>Underwriter Officer Details</strong></p><br />
        <asp:ListView ID="ListView2" runat="server" ItemPlaceholderID="PlaceHolder1">
        <ItemTemplate>
