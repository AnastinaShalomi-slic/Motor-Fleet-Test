<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProcessReports.aspx.cs" Inherits="Reports_ProcessReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Fire Policy Request Reports</label>
        </div>
        <div class="form-group row" runat="server">
        ...
        <div class="form-group row" runat="server">
            ...
            <div class="col-sm-2 mr-0 testClass" runat="server">
                ...
                <asp:TextBox ID="txt_start_date" runat="server" CssClass="form-control text-center testClass" ClientIDMode="Static" placeholder="From Date" autocomplete="off"></asp:TextBox>
            </div>
            ...
            <div class="col-sm-2 mr-0 testClass" runat="server">
                ...
                <asp:TextBox ID="txt_to_date" runat="server" CssClass="form-control text-center testClass" ClientIDMode="Static" placeholder="To Date" autocomplete="off"></asp:TextBox>
            </div>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="Grid_Details" Visible="true" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="8"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Cus. Address" DataField="CUS_ADD_LINES" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    ...
                                    <asp:BoundField HeaderText="Risk. Address" DataField="CUS_RISK_ADD" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Value of building" DataField="DH_VALU_BUILD" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Value of boundary and parapet wall" DataField="DH_VALU_WALL" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    ...
                                    <asp:BoundField HeaderText="Net Premium" DataField="SC_NET_PRE" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="SRCC" DataField="SC_RCC" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="TC" DataField="SC_TR" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Admin Fee" DataField="SC_ADMIN_FEE" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Taxes" DataField="TAX" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Renewal Fee" DataField="SC_RENEWAL_FEE" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Policy Fee" DataField="SC_POLICY_FEE" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    ...
                                    <asp:BoundField HeaderText="Commencement Date" DataField="fromDate" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass" />
                                    <asp:BoundField HeaderText="Debit No"  DataField="DEBIT_NO" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/> 
                                    <asp:BoundField HeaderText="Policy Entered Date" DataField="Entered_on" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass" />
                                    ...
                                    <asp:BoundField HeaderText="Covers" DataField="REQ_COVERS" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Bank User" DataField="DH_ENTERED_BY" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Loading(%)" DataField="dh_loading_val" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Conditions" DataField="dh_conditions" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Deduct Pre(%)" DataField="ded_precentage" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Deduct Value" DataField="added_deduct" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="SLIC User(hold requests attended user)" DataField="updated_by" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="SLIC finished Date" DataField="updatedDate" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Remarks" DataField="remarks" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />

                                    <asp:BoundField HeaderText="BPF Req." DataField="BPF" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="BPF Fee" DataField="BP_FEE" DataFormatString="{0:n2}" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />

                                    <%-- <asp:BoundField HeaderText="Region"  DataField="BREGION"  ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                               <asp:BoundField HeaderText="SP Name"  DataField="BNAME"  ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    --%>
                                    <asp:BoundField HeaderText="SLIC Code" DataField="SLIC_CODE" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                                    <asp:BoundField HeaderText="Designation" DataField="DESIG" ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
