...
public partial class SLIC_Side_RequestView : System.Web.UI.Page
{
    ...
    protected void GetDetails(string start_date, string end_date,string req_id, string app_status)
    {
        ...
        try
        {
            details = orcle_trans.GetRows(this._sql.GetReqDetails(start_date, end_date, req_id, app_status, ddl_bank.SelectedValue.ToString(), ddl_branch.SelectedValue.ToString(),"A"), details);
    ...
    protected void SelectRecord_Click(object sender, EventArgs e)
    {
        ...
        // Session["po_#number"] = arg[1].ToString().Trim();
        string REQ_ID = arg[0].ToString().Trim();
        //string V_TYPE = arg[1].ToString().Trim();
        //string YOM = arg[2].ToString().Trim();
        //string SUM_INSU = arg[3].ToString().Trim();
        //string vh_make = arg[4].ToString().Trim();

        //string model_name = arg[5].ToString().Trim();
        //string PURPOSE = arg[6].ToString().Trim();
        //string ENTERED_ON = arg[7].ToString().Trim();
        string FLAG = arg[1].ToString().Trim();
        string QUO_NO = arg[2].ToString().Trim();

        //string V_REG_NO = arg[10].ToString().Trim();

        //string CUS_NAME = arg[11].ToString().Trim();
        //string CUS_PHONE = arg[12].ToString().Trim();
        //string ENTERED_BY = arg[13].ToString().Trim();
        //string V_FUEL = arg[14].ToString().Trim();
        ...
        Response.Redirect("~/SLIC_Side/ViewPageSecond.aspx?REQ_ID=" + en.Encrypt(REQ_ID.Trim()) + "&V_FLAG=" + en.Encrypt(FLAG.Trim()) + "&V_QUO=" + en.Encrypt(QUO_NO.Trim()));
    ...
    protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                {
                    //cell.BackColor = Color.FromName("#ffcccc"); //#cffae2
                    e.Row.Cells[11].BackColor = Color.FromName("#add8e6");

                }
                else if (op_ststus.Equals("Cancel"))
                {
                    //cell.BackColor = Color.FromName("#ffcccc"); //#cffae2
                    e.Row.Cells[11].BackColor = Color.FromName("#D5D8DC ");
