<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RequestView.aspx.cs" Inherits="SLIC_Side_RequestView" Culture = "en-GB"%>
        ...
        $(function () {
            $("[id$=txt_req_id]").autocomplete({
                ...
                source: function (request, response) {
                    ...
                    $.ajax({
                        url: '<%=ResolveUrl("~/SLIC_Side/RequestView.aspx/GET_REQ_ID") %>',
    ...
    <asp:HiddenField ID="brCode" runat="server" />
      ...
      <div class="" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Motor Quotation Request View</label>
        </div>
       <div class="form-group row" runat="server">
          ...
          <div class="form-group row" runat="server">
              ...
              <asp:TextBox ID="txt_req_id" runat="server" CssClass="form-control text-center testClass"  ClientIDMode="Static" placeholder="Req. ID"></asp:TextBox>  
              </div>
           ...
           <div class="col-sm-2 mr-0 testClass" runat="server">
             ...
             <div class="col-sm-2 mr-0 testClass" runat="server">
                  ...
                  <asp:ImageButton ID="ImageButton8" runat="server" ImageAlign="Middle" 
                                ...
                                ToolTip="Click here to download as excel file" class="btn btn-success testClass mr-1 mt-4 ml-1 img-fluid" 
                                    onclick="ImageButton8_Click" Visible="false" />
                 </div>
        </div>
                        ...
                        <ContentTemplate>
                            ...
                            <Columns>                            
                              <asp:TemplateField HeaderText="S.No" HeaderStyle-CssClass="text-dark testClassHeader" ItemStyle-CssClass="text-black-100 testClass">
                               ...
                               <asp:BoundField HeaderText="CUS_NAME"  DataField="CUS_NAME"  ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />      
                               <asp:BoundField HeaderText="CUS_PHONE"  DataField="CUS_PHONE"  ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />
                               ...
                               <asp:BoundField HeaderText="QUO_NO"  DataField="QUO_NO"  ItemStyle-CssClass="ui_comp_hide" HeaderStyle-CssClass="ui_comp_hide" />

                               <asp:TemplateField HeaderText="Add Quotation" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass">
                                <ItemTemplate>
                                <asp:ImageButton ID="imgbtn_select" runat="server"  CommandArgument = '<%#Eval("REQ_ID")+";"+ Eval("FLAG")+";"+ Eval("QUO_NO")%>'  CausesValidation= "false" 
