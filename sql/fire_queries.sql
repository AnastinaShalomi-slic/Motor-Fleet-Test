...
CREATE TABLE QUOTATION.FIRE_DH_PROPOSAL_ENTRY
  ...
  CREATE TABLE QUOTATION.FIRE_DH_CONTACT_EMAILS
   ...
   SELECT * FROM QUOTATION.CONTACT_EMAILS
...
INTO QUOTATION.FIRE_DH_CONTACT_EMAILS VALUES ('0004','7010','BOC','KAVINDA MADUSHAN','kavindad@srilankainsurance.com', 'Y','9641',sysdate,'A')
INTO QUOTATION.FIRE_DH_CONTACT_EMAILS VALUES ('0004','7135','PEOPLES BANK ','KAVINDA MADUSHAN','kavindad@srilankainsurance.com', 'Y','9641',sysdate,'A')
...
UPDATE QUOTATION.FIRE_DH_PROPOSAL_ENTRY set DH_ISREJECT = 'Y' where dh_refno = 'FFPD/383'
  ...
  ඔබගේ සුරක්ෂා හිමිකමට අදාල නිරාකරණ කටයුතු සැකසෙමින් පවති
