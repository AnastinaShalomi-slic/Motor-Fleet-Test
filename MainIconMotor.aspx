<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainIconMotor.aspx.cs" Inherits="MainIconMotor" %>
   ...
   .img_sizeIcon
    {
     ...
     .CardBackgroundMain
     {
         ...
         .testClass
        {
         ...
         .backGround
      {
          background-color:#026888;  /*#45B39D*/
...
<body class="backGround" runat="server">
   ...
   <form id="form1" runat="server" class="m-4"> 
       <div class="form-group row mt-2" runat="server" id="Div3">

            <div class="col-sm-3" runat="server"></div>
             <div class="col-sm-6 text-center" runat="server">
                 <a runat="server" title="Home" id="a1"  href="MainIconMotor.aspx" class="">
                        
                     <label runat="server" id="Label1" class="text-center text-capitalize text-white font-weight-normal">
                         <img runat="server" id="Img2" src="~/Images/116.png" class="img-fluid d-block mx-auto img_sizeHome"/>
                         Motor Online System</label>
                 </a>
          ...
          <div class="form-group row mt-2" runat="server" id="Div2">
             ...
             <div class="col-sm-3 text-center" runat="server">  
                   <a runat="server" title="Home" id="a2"  href="MainIconMotor.aspx" class="">
                        <img runat="server" id="Img1" src="~/Images/HomeIconSecond.png" class="img-fluid img_sizeIcon" />
                 </a>
  ...
  <a runat="server" href="~/Bank/Details_Entry.aspx" class="stretched-link">
        ...
        <h5 class="card-title text-center item_cssSecond text-white" runat="server">Request Quotation</h5>
        </div>
    </div>
  ...
  <a runat="server" href="~/Bank/ViewQuotations.aspx" class="stretched-link">
        <img src="~/images/viewReq.png" class="card-img-top img-fluid img_sizeMain d-block mx-auto centerIconPanelMain" alt="..." runat="server"/>           
          ...
          <div class="card-footer text-center" runat="server">
        <h5 class="card-title text-center item_cssSecond text-white" runat="server">View Quotation</h5>
        </div>
    </div>
  ...
  <a runat="server" href="~/Contacts/Default.aspx" class="stretched-link">
  ...
  <a runat="server" href="~/SLIC_Side/RequestView.aspx" class="stretched-link">
        <img src="~/images/viewReq.png" class="card-img-top img-fluid img_sizeMain d-block mx-auto centerIconPanelMain" alt="..." runat="server"/>           
     </a>    
            </div>
          
          <div class="card-footer text-center" runat="server">
        <h5 class="card-title text-center item_cssSecond text-white" runat="server">View Requests</h5>
        </div>
    </div>
...
<div class="card CardBackgroundMain h-50 pb-2 cardProp" runat="server" id ="pagethirteen">
  ...
  <a runat="server" href="~/UserMannual/PolicyFireBooklet.aspx" class="stretched-link">
        ...
        <h5 class="card-title text-center item_cssSecond text-white" runat="server">Policy Booklet</h5>
             ...
             <div class="card CardBackgroundMain h-50 pb-2 cardProp" runat="server" id ="pagefourteen">
        
        <div class="p-2" runat="server">
        
  <a runat="server" href="~/UserMannual/ProposalForms.aspx" class="stretched-link">
        <img src="~/images/proposalForm.png" class="card-img-top img-fluid img_sizeMain d-block mx-auto centerIconPanelMain" alt="..." runat="server"/>           
          ...
          <div class="card-footer text-center" runat="server">
        <h5 class="card-title text-center item_cssSecond text-white" runat="server">Proposal Forms</h5>
        </div>
    </div>
  ...
  <a runat="server" href="~/AdminPanel/AdminViewMotor.aspx" class="stretched-link">
