<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BankTicket.aspx.cs" Inherits="BankResponseTeam_BankTicket" %>
           ...
           var ddl1 = $('#<%=ddlStatus.ClientID %>').val();
            ...
            var ddl3 = $('#<%=ddlStatus.ClientID %>').val();
              if ((ddl2=="1")||(ddl2=="2")||(ddl2=="3")||(ddl2=="4"))
                 ...
                 custom_alert('Success! Inquiry send to SLIC. \n\n Reference No. '+displyRef, 'Success'); 
                    ...
                    $('#<%= txt_req_id.ClientID%>').autocomplete({
                        ...
                        source: function (request, response) {
                            ...
                            $.ajax({
                                 ...
                                 url: '<%=ResolveUrl("~/BankResponseTeam/BankTicket.aspx/Get_Ticket_No") %>',
...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release"> </asp:ToolkitScriptManager>
    ...
    <asp:HiddenField ID="bankEnmailId" runat="server" />
     ...
     <div class="m-2" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Quick response team - send inquiries to Bancassurance (GI) team through this system.</label>
        </div>
         <div class="form-group row" runat="server">
  ...
  <asp:UpdatePanel ID="UpdatePanel4" runat="server" updatemode="Conditional">
    ...
    <div class="container" id="progressId" runat="server">
          ...
          <div class="jumbotron text-center m-2" id="idNew" runat="server">
        <asp:LinkButton class="btn btn-large btn-success col-sm-6" runat="server" OnClick="btNewClick">
        ...
        <asp:LinkButton class="btn btn-large btn-success col-sm-6" runat="server" onclick="btViewClick">
           <i class="fa fa-envelope h2" aria-hidden="true"></i>
                <span class="h1 font-weight-bold text-center text-white m-3">View Inquiry Response</span>
        </asp:LinkButton>
         </div>
      ...
      <div runat="server" id="divNew">
        ...
        <hr />
         ...
         <div class="form-group row" runat="server" id="rowRef" visible="false">
       ...
       <asp:FileUpload runat="server" ID="FileUpload1" AllowMultiple="true" Width="100%" Class="h-100 bg-transparent form-control"/>
         ...
         <div class="form-group row" runat="server" id="rowFinish">
            ...
            <div class="col-sm-2" runat="server">
                <asp:Button ID="btfinished" runat="server" Text="Send Inquiry" class="btn btn-success"   ClientIDMode="Static" OnClick="btfinished_Click" OnClientClick="return clientFunctionValidationFinished()"/> 
            </div>
          </div>
        <hr />
 ...
 <div class="form-group row" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="Grid_Details" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="8"
                              ...
                              <asp:TemplateField HeaderText="S.No" HeaderStyle-CssClass="text-dark testClassHeader" ItemStyle-CssClass="text-black-100 testClass">
                                ...
                                <asp:BoundField HeaderText="Craeted Date"  DataField="T_CREATED_ON" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>                                
                               ...
                               <ItemTemplate>
                                   ...
                                   <asp:ImageButton ID="imgbtn_select" runat="server"  CommandArgument = '<%#Eval("T_REF")+";"+ Eval("T_STATUS")%>'  CausesValidation= "false" 
          ...
          <div runat="server" id="moreInfo">
            ...
            <label for="" class="col-sm-6 font-weight-bolder h6 text-center" id="txtBankLbl" runat="server"></label>
            <label for="" class="col-sm-6 font-weight-bolder h6 text-center" runat="server" id="txtSlicLbl"></label>
        </div>
              <div class="form-group row"> 
                  <%--bank document--%>
                  <div class="col-sm-6 font-weight-bold d-flex justify-content-center align-items-center" runat="server">
