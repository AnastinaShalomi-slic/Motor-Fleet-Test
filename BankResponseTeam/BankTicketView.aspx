<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BankTicketView.aspx.cs" Inherits="BankResponseTeam_BankTicketView" %>
    ...
    <asp:HiddenField ID="bankEnmailId" runat="server" />
     ...
     <div class="m-2" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Quick Response Team - Send and View your ticket through this system.</label>
        </div>
         <div class="form-group row" runat="server">
    ...
    <div class="container" id="progressId" runat="server">
        ...
        <asp:LinkButton class="btn btn-large btn-success col-sm-4" runat="server" OnClick="btNewClick">
           <i class="fa fa-paper-plane h2" aria-hidden="true"></i>
                <span class="h1 font-weight-bold text-center text-white m-3">New Ticket</span>
        </asp:LinkButton>
         </div>
        ...
        <asp:LinkButton class="btn btn-large btn-success col-sm-4" runat="server" onclick="btViewClick">
           <i class="fa fa-envelope h2" aria-hidden="true"></i>
                <span class="h1 font-weight-bold text-center text-white m-3">View Ticket</span>
        </asp:LinkButton>
         </div>
      ...
      <div runat="server" id="divNew">
        <hr />
         <div class="form-group row" id="rowOpt" runat="server">
              <label class="col-sm-3 font-weight-bold" runat="server">Ticket Types</label>
       ...
       <div class="form-group row" runat="server">
          ...
          <div class="form-group row" runat="server">
              ...
              <asp:TextBox ID="txt_end_date" runat="server" CssClass="form-control text-center testClass"  ClientIDMode="Static" ValidationGroup="VG0001" placeholder="To Date" autocomplete="off"></asp:TextBox>  
               ...
               <div class="col-sm-2 mr-0 testClass" runat="server">
                    <label class="font-weight-bold testClass" runat="server">Ticket Number</label>
              <asp:TextBox ID="txt_req_id" runat="server" CssClass="form-control text-center testClass"  ClientIDMode="Static" placeholder="Ticket No."></asp:TextBox>  
              </div>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="Grid_Details" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="8"
                              ...
                              <asp:TemplateField HeaderText="S.No" HeaderStyle-CssClass="text-dark testClassHeader" ItemStyle-CssClass="text-black-100 testClass">
                                ...
                                <asp:BoundField HeaderText="Ticket Number"  DataField="T_REF" HeaderStyle-CssClass="text-black-100 testClassHeader" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-black-100 testClass"/>   
