<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="FireRenewal.aspx.cs" Inherits="SLIC_Fire_FireRenewal" Culture="en-GB" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        function clientFunctionValidation2() {
            ...
            if (reqPhone !== "") {
                ...
                if (!regex.test(reqPhone)) {
                    ...
                    $('#<%= txtCusMobNoVali.ClientID%>').css("display", "");
                    $('#<%= txtCusMobNoVali.ClientID%>').html("Please enter a valid phone number!");
                    return false;
                }
            }
    ...
    <div id="viewPropId" runat="server">
        ...
        <div class="form-group row" runat="server">
            <div class="col-sm-4 offset-sm-1">
                ...
                <%--<asp:Button ID="Button2" runat="server" Text="Test Short URL" Style="background-color: #008B80;" CssClass="btn btn-success" OnClick="btn_shortn_Click1" OnClientClick="return clientFunctionValidation()" />--%>
            </div>
        </div>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="NBT" Visible="false">
                    <ItemTemplate>
                        ...
                        <%--<asp:HiddenField ID="lblNbt" runat="server" Value='<%# Bind("NBT") %>' />--%>
                ...
                <asp:TemplateField HeaderText="VAT" Visible="false">
                    <ItemTemplate>
                        ...
                        <%--<asp:HiddenField ID="lblVat" runat="server" Value='<%# Bind("NBT") %>' />--%>
                ...
                <asp:TemplateField HeaderText="AdminFeeVal" Visible="false">
                    <ItemTemplate>
                        ...
                        <%-- <asp:HiddenField ID="lblAdminFeeVal" runat="server" Value='<%# Bind("ADMINFEE") %>' />--%>
    ...
    <script type="text/javascript">
        ...
        function validateCheckbox(cb) {
            ...
            if (phoneInput) {
                ...
                if (!phoneRegex.test(phone)) {
                    custom_alert('Please enter valid customer mobile number or landline number.', 'Alert');
                    cb.checked = false;
                    return false;
                }
            }
        ...
        function toggleAllCheckboxes(source) {
            ...
            if (validCount < checkboxes.length && source.checked) {
                ...
                custom_alert('Some rows were not selected because they are missing a valid mobile number.', 'Alert');
            }
    ...
    <asp:HiddenField runat="server" ID="HiddenFieldSelectedRowIndex" />
        ...
        <div class="popup-container">
            ...
            <div class="popup-grid">
                ...
                <div class="form-group-pop">
                    ...
                    <%--<asp:TextBox ID="txtRemrPop" runat="server" CssClass="form-control-pop" TextMode="MultiLine" Rows="3" />--%>
                    <asp:TextBox ID="txtRemrPop" runat="server" TextMode="MultiLine" CssClass="form-control-pop" Rows="5" />
                </div>
                ...
                <div class="form-group-pop" runat="server" visible="false">
                    <%-- NAme NBT change to SSL --%>
            ...
            <asp:Panel ID="Panel2" runat="server" CssClass="table-container">
                <table border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
                    <thead style="background-color: #f1f1f1;">
                        <tr>
                            <th style="width: 10%;"><b>Excess Id</b></th>
            ...
            <br />
            <asp:HiddenField runat="server" ID="hiddenAdmFeeVal1" />
            <div class="popup-buttons">
                ...
                <asp:Button ID="btnSave" Enabled="false" runat="server" Text="Save" Style="background-color: #008B80;" CssClass="btn btn-success" OnClick="btnEditSave_Click" OnClientClick="return clientFunctionValidation1()" />
        ...
        <div id="renewFormSection">
            ...
            <div class="form-section" style="padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9; max-width: 100%; overflow-x: auto;">
                ...
                <a href="http://insurance-app/Beegeneral/clmworks/Claims%20inquiry%20Report/claimsInquiryIndex.asp"
                    ...
                    class="btn btn-primary">Open Report
                </a>
