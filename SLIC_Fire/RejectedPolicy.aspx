<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RejectedPolicy.aspx.cs" Inherits="SLIC_Fire_RejectedPolicy" %>
    ...
    <asp:HiddenField ID="brCode" runat="server" />
     ...
     <div class="" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Rejected Fire Policy View</label>
        </div>
       <div class="form-group row" runat="server">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddl_status" runat="server" class="custom-select testClass text-center"
                               ...
                               <asp:ListItem Text="Rejected" Value="R" Selected="True"></asp:ListItem>
                           </asp:DropDownList>      
                        </ContentTemplate>
                        <Triggers>
