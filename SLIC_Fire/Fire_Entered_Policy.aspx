<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Fire_Entered_Policy.aspx.cs" Inherits="SLIC_Fire_Fire_Entered_Policy" Culture = "en-GB"%>
    ...
    <asp:HiddenField ID="brCode" runat="server" />
     ...
     <div class="" id="viewPropId" runat="server">
        <div class="form-group row" runat="server">
            <label for="" class="col-sm-12 font-weight-bolder h5 text-center">Pending Fire Policy View</label>
        </div>
       <div class="form-group row" runat="server">
                        ...
                        <ContentTemplate>
                            <asp:DropDownList ID="ddl_status" runat="server" class="custom-select testClass text-center"
                             ...
                             <%--  <asp:ListItem Text="Completed" Value="N" Selected="True"></asp:ListItem>--%>
                               <asp:ListItem Text="Pending" Value="Y" Selected="True"></asp:ListItem> 
