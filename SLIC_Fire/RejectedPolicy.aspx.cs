...
public partial class SLIC_Fire_RejectedPolicy : System.Web.UI.Page
{
            ...
            try
            {
                ...
                if (Auth == "admin")
                {
                    ...
                    if (Session["UserId"].ToString() != "")
                    {
                        ...
                        //this.IniGridview();
                        //this.GetDetails(txt_start_date.Text.Trim(), txt_to_date.Text.Trim(), txt_req_id.Text.Trim().ToUpper(), "R", txtNicNo.Text.Trim());
    ...
    protected void btexcel_Click(object sender, EventArgs e)
    {
        ...
        if (Grid_Details.Rows.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=FirePolicyRejected.xls");
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                string wz = "Fire Policy Rejected Report<br/>" +
                "Report Description : PDH Fire Policy Rejected Report. (" + ddlTerm.SelectedItem.ToString() + "/" + ddlPropType.SelectedItem.ToString() + ")<br/>" +
    ...
    private void ExportGridToExcel()
    {
        ...
        using (XLWorkbook wb = new XLWorkbook())
        {
            ...
            ws.Cell(2, 2).Value = "Fire Policy Rejected Report";
            ws.Cell(2, 2).Style.Font.Bold = true;

            ws.Cell(3, 2).Value = "Report Description : PDH Fire Policy Rejected Report.";
            ...
            Response.AddHeader("content-disposition", "attachment;filename=FirePolicyRejected.xlsx");
