<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="FireDefault.aspx.cs" Inherits="FireDefault" %>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" id="PB" runat="server">
                    <div class="carousel-item active">
                        ...
                        <img class="d-block w-100" src='<%:ResolveUrl("~/Images/FireRenewalImg4.png")%>' alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src='<%:ResolveUrl("~/Images/FireRenewalImg3.png")%>' alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
                ...
                <%--<div class="carousel-inner" id="SLIC" runat="server">
                    <div class="carousel-item active">
                        <img class="d-block" style="max-width: 400px;  margin: 0 auto;" src='<%:ResolveUrl("~/Images/FireRenewalImg4.png")%>' alt="First slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img class="d-block" style="max-width: 400px;  margin: 0 auto;" src='<%:ResolveUrl("~/Images/FireRenewalImg3.jpg")%>' alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
                ...
                <div class="carousel-inner" id="SLIC" runat="server">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" style="width: 400px; height: 300px; object-fit: cover; margin: 0 auto;" src='<%:ResolveUrl("~/Images/FireRenewalImg4.png")%>' alt="First slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img class="d-block img-fluid" style="width: 400px; height: 300px; object-fit: cover; margin: 0 auto;" src='<%:ResolveUrl("~/Images/FireRenewalImg3.png")%>' alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img class="d-block img-fluid" style="width: 400px; height: 300px; object-fit: cover; margin: 0 auto;" src='<%:ResolveUrl("~/Images/FireRenewalmg2.jpg")%>' alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img class="d-block img-fluid" style="width: 400px; height: 300px; object-fit: cover; margin: 0 auto;" src='<%:ResolveUrl("~/Images/FireRenewalImg5.png")%>' alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Sri Lanka Insurance</h5>
                            <p>Largest and strongest composite insurance provider in Sri Lanka</p>
                        </div>
